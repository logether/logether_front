    ...
    <main class="py-8 px-8">
      <div class="container mx-auto py-8 h-64">
        <div class="grid grid-cols-7 gap-4">
          ...
          <ScheduleCard v-for="(day, index) in days" :key="index" :date="day.date" :dayOfWeek="day.dayOfWeek"
            :tasks="day.tasks" />
        </div>
      </div>
      ...
      <section class="flex items-center justify-center gap-12">
        ...
        <section>
          ...
          <div class="bg-white dark:bg-gray-700 shadow-md rounded-lg p-4 transition duration-300">
            <!-- 캐릭터 리스트 표시 -->
            <div class="flex flex-wrap gap-4 h-64">
              <!-- 캐릭터 이미지 -->
              <div class="w-16 h-16 bg-gray-300 dark:bg-gray-500 rounded-full"></div>
              <div class="w-16 h-16 bg-gray-300 dark:bg-gray-500 rounded-full"></div>
              <div class="w-16 h-16 bg-gray-300 dark:bg-gray-500 rounded-full"></div>
              <!-- 캐릭터 이미지 추가 -->
            </div>
      ...
      <!-- 사이트 정보 섹션 -->
      <footer class="mt-8 bg-white dark:bg-gray-700 shadow-md rounded-lg p-4 text-center transition duration-300">
